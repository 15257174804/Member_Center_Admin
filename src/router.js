...
const router = new Router({
  ...
  routes: [
    ...
    { path: "/reguer", component: () => import('./views/reguser.vue') },
    { path: "/choose", component: () => import('./views/Choose.vue') },
    { path: "/regcompany",name:'regcompany', component:regcompany  },
    {
      path: "/display", component: display, name: "home", meta: { title: '#' }, redirect: "/home", children: [
        ...
        { path: "/personal", name: "personal", meta: { title: '个人中心' }, component: () => import('./components/Personal.vue') },
        { path: "/driver", name: "driver", meta: { title: '引导' }, component: () => import('./components/driver/Driver.vue') },
        { path: "/complain", name: "complain", meta: { title: '意见反馈' }, component: () => import('./views/complain.vue') },
        ...
        { path: "/companyadd", name:"companyadd", meta: { title: '企业编辑',keepAlive: false }, component: () => import('./components/organization/company-info.vue') },
        { path: "/employeeadd", name: "employeeadd", meta: { title: '员工编辑' ,keepAlive: false}, component: () => import('./components/organization/employee-add.vue') },
        ...
        //积分商品
        { path: "/integralgood", name: "integralgood", meta: { title: '积分兑换商品列表' ,keepAlive: true}, component: () => import('./components/integral/integralgood.vue') },
        { path: "/integoodadd", name: "integoodadd", meta: { title: '积分兑换商品编辑' ,keepAlive: true}, component: () => import('./components/integral/integoodadd.vue') },
        //会员列表
        { path: "/customlist", name: "customlist", meta: { title: '会员列表',keepAlive: true }, component: () => import('./components/integral/customlist.vue') },
        { path: "/customdetial", name: "customdetial", meta: { title: '会员详情' ,keepAlive: true}, component: () => import('./components/integral/customdetial.vue') },
        
        //合伙人
        { path: "/rebateset", name: "rebateset", meta: { title: '返利设置',keepAlive: true }, component: () => import('./components/partner/rebateset.vue') },
        { path: "/rebatelist", name: "rebatelist", meta: { title: '返利明细' ,keepAlive: true}, component: () => import('./components/partner/rebatelist.vue') },
        { path: "/partnerlist", name: "partnerlist", meta: { title: '合伙人列表',keepAlive: true }, component: () => import('./components/partner/partnerlist.vue') },
        { path: "/recordlist", name: "recordlist", meta: { title: '提现记录' ,keepAlive: true}, component: () => import('./components/partner/recordlist.vue') },
      ]
    },
